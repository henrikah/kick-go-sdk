...
func Test_GetChannelsByIDUnAuthorized_Error(t *testing.T) {
	// Arrange
...
func Test_GetChannelsByBroadcasterUserID_Success(t *testing.T) {
	...
	httpClient := &mocks.MockHTTPClient{
		DoFunc: func(req *http.Request) (*http.Response, error) {
			if req.URL.String() != "https://api.kick.com/public/v1/channels?broadcaster_user_id=1&broadcaster_user_id=2" {
